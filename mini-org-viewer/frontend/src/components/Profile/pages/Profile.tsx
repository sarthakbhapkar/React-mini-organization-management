                ...
                <Grid size={{xs: 12, md: 4}}>
                    <Card sx={{mb: 3}}>
                        <CardContent>
                            ...
                            {user.team_id ? (
                                <>
                                    <Typography sx={{fontSize: 16}}><strong>Team ID:</strong> {user.team_id}
                                    </Typography>
                                    <Typography sx={{mt: 1, fontSize: 16}}><strong>Team Name:</strong> {team?.name}
                                    </Typography>
                                </>
                            ) : (
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <Typography sx={{fontSize: 16}}><strong>Sick Leaves:</strong> {balance.sick_leave ?? '-'}
                            </Typography>
                            <Typography sx={{fontSize: 16}}><strong>Casual
                                Leaves:</strong> {balance.casual_leave ?? '-'}</Typography>
                            <Typography sx={{fontSize: 16}}><strong>WFH:</strong> {balance.work_from_home ?? '-'}
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                            ...
                            <Box sx={{mt: 3}}>
                                {editMode ? (
                                    ...
                                    <Button variant="contained" startIcon={<EditIcon/>}
                                            sx={{backgroundColor: '#263238'}} onClick={() => setEditMode(true)}>
                                        Edit Profile
                                    </Button>
                                )}
                            </Box>
